...
public class PlannerDto {
	...
	public PlannerDto() { }
	public PlannerDto(int plannerIdx, int userIdx, int cityIdx, String title, Date startDate, Date endDate, String completeYN) {
		this.plannerIdx = plannerIdx; this.userIdx = userIdx;
		this.cityIdx = cityIdx; this.title = title;
